    ...
    public class XMLParser
    {
        ...
        public Trial parseTrial()
        {
            ...
            if (isValidTrial())
            {
                ...
                trial.Origin.XPos = (getTrialStartTargetPosition()[0] - trial.PositionOffset.X ) / 100.0f;
                trial.Origin.YPos = (getTrialStartTargetPosition()[1] - trial.PositionOffset.Y) / 100.0f;
                trial.Origin.ZPos = (getTrialStartTargetPosition()[2] - trial.PositionOffset.Z) / 100.0f;
                ...
                trial.Target.XPos = (getTrialEndTargetPosition()[0] - trial.PositionOffset.X) / 100.0f;
                trial.Target.YPos = (getTrialEndTargetPosition()[1] - trial.PositionOffset.Y) / 100.0f;
                trial.Target.ZPos = (getTrialEndTargetPosition()[2] - trial.PositionOffset.Z) / 100.0f;
