...
{
    internal class _02_Adapt_T4T3_Day2 : AbstractSzenarioDefinition
    {
        public new const string StudyName = "Study_11";

        public new const string SzenarioName = "02_Adapt_T4T3_Day2";

        public override int TrialCount => 256;
