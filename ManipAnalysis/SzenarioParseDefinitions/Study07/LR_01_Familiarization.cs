...
{
    internal class LR_01_Familiarization : ISzenarioDefinition
    {
        new public const string StudyName = "Study 7";

        new public const string SzenarioName = "LR_01_Familiarization";

        new public const int TrialCount = 336;
