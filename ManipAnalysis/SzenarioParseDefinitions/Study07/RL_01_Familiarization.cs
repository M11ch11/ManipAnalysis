...
namespace ManipAnalysis_v2.SzenarioParseDefinitions
{
    internal class RL_01_Familiarization : ISzenarioDefinition
    {
        ...
        public const int TrialCount = 336;
        ...
        public override Trial setTrialMetadata(ManipAnalysisGui myManipAnalysisGui, Trial trial)
        {
            ...
            else
            {
                ...
                {
                    trial.Target.XPos = Math.Cos(135);
                    trial.Target.YPos = Math.Sin(135);
                    trial.Target.ZPos = 0;
                    trial.Target.Radius = 0.175;
                }
                else if (trial.Target.Number == 2)
                {
                    trial.Target.XPos = Math.Cos(90);
                    trial.Target.YPos = Math.Sin(90);
                    trial.Target.ZPos = 0;
                    trial.Target.Radius = 0.175;
                }
                else if (trial.Target.Number == 3)
                {
                    trial.Target.XPos = Math.Cos(45);
                    trial.Target.YPos = Math.Sin(45);
                    trial.Target.ZPos = 0;
                    trial.Target.Radius = 0.175;
                }
                ...
                {
                    trial.Szenario = "RL_Familiarization";
                ...
                else if (trial.TrialNumberInSzenario >= 325 && trial.TrialNumberInSzenario <= TrialCount)
                {
