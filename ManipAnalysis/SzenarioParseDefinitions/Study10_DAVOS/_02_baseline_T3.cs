...
{
    internal class _02_baseline_T3 : AbstractSzenarioDefinition
    {
        public new const string StudyName = "Study_10_sleep";

        public new const string SzenarioName = "02_baseline_T3";

        public override int TrialCount => 36; //Number of valid trials(without skipped/nulled Trials for PositionControl
        ...
        public override Trial SetTrialMetadata(ManipAnalysisGui myManipAnalysisGui, Trial trial)
        {
            ...
            else
            {
                ...
                if (trial != null && (trial.TrialNumberInSzenario < 1 || trial.TrialNumberInSzenario > 73)) //73 is the number of all trials in this szenario
                {
