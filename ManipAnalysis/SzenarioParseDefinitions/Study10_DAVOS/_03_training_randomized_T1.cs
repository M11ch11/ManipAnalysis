...
{
    internal class _03_training_randomized_T1 : AbstractSzenarioDefinition
    {
        public new const string StudyName = "Study_10_sleep";

        public new const string SzenarioName = "03_training_randomized_T1";

        public override int TrialCount => 150; //Number of valid trials(without skipped/nulled Trials for PositionControl
        ...
        public override Trial SetTrialMetadata(ManipAnalysisGui myManipAnalysisGui, Trial trial)
        {
            ...
            else
            {
                ...
                if (trial != null && (trial.TrialNumberInSzenario < 1 || trial.TrialNumberInSzenario > 301)) //301 is the number of all trials in this szenario
                {
