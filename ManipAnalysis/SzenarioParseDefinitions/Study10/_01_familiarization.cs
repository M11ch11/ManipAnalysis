...
{
    internal class _01_familiarization : ISzenarioDefinition
    {
        public const string StudyName = "Study 10";

        public const string SzenarioName = "01_familiarization";
        ...
        public override Trial setTrialMetadata(ManipAnalysisGui myManipAnalysisGui, Trial trial)
        {
            ...
            else
            {
                ...
                else if (trial.Target.Number >= 11 && trial.Target.Number <= 28) // Null, Position control, skip
                {
                    trial.Target.Number = trial.Target.Number;
                    trial.ForceFieldType = Trial.ForceFieldTypeEnum.NullField;
                ...
                if (trial != null && (trial.TrialNumberInSzenario < 1 || trial.TrialNumberInSzenario > 288))
                {
