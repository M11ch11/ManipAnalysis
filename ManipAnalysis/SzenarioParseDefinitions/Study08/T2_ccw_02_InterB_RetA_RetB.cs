...
{
    internal class T2_ccw_02_InterB_RetA_RetB : ISzenarioDefinition
    {
        public new const string StudyName = "Study 08";

        public new const string SzenarioName = "T2_ccw_02_InterB_RetA_RetB";
            ...
            else
            {
                         ...
                         (trial.Target.Number >= 34 && trial.Target.Number <= 36)) // ErrorClampTrial + CCW ForceField
                {
                    ...
                    trial.ForceFieldMatrix[1, 1] = 0;
                         ...
                         (trial.Target.Number >= 37 && trial.Target.Number <= 39)) // ErrorClampTrial + CW ForceField
                {
                ...
                {
                    myManipAnalysisGui.WriteToLogBox("Invalid Target-Number. " + trial.Szenario +
