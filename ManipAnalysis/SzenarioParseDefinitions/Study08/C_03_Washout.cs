...
{
    internal class C_03_Washout : ISzenarioDefinition
    {
        public const string StudyName = "Study 8";

        public const string SzenarioName = "C_03_Washout";
        ...
        public override Trial setTrialMetadata(ManipAnalysisGui myManipAnalysisGui, Trial trial)
        {
            ...
            else
            {
                ...
                if (trial.TrialNumberInSzenario < 1 || trial.TrialNumberInSzenario > 64)
                {
