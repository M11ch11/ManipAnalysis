...
{
    internal class T2_ccw_01_Fam_Base_TrainA : AbstractSzenarioDefinition
    {
        public new static string StudyName => "Study 08";

        public new static string SzenarioName => "T2_ccw_01_Fam_Base_TrainA";

        public override int TrialCount => 436;
        ...
        public override Trial SetTrialMetadata(ManipAnalysisGui myManipAnalysisGui, Trial trial)
        {
            ...
            if (trial.TrialNumberInSzenario >= 129 && trial.TrialNumberInSzenario <= 132 ||
                trial.TrialNumberInSzenario >= 177 && trial.TrialNumberInSzenario <= 180)
            {
            ...
            else
            {
                         ...
                         (trial.Target.Number >= 14 && trial.Target.Number <= 16)) // CCW ForceField
                {
                    ...
                    trial.ForceFieldMatrix[1, 1] = 0;
                         ...
                         (trial.Target.Number >= 17 && trial.Target.Number <= 19)) // CW ForceField
                {
                    ...
                    // 30s Pause + Wechsel R=>L + CCW ForceField
                {
                    ...
                    trial.ForceFieldType =
                        Trial.ForceFieldTypeEnum.ForceFieldCCW;
                    trial.TrialType = Trial.TrialTypeEnum.StandardTrial;
                    trial.ForceFieldMatrix[0, 0] = 0;
                    trial.ForceFieldMatrix[0, 1] = -15;
                    trial.ForceFieldMatrix[1, 0] = 15;
                ...
                else if (trial.Target.Number >= 64 &&
                         trial.Target.Number <= 66)
                ...
                else if (trial.Target.Number >= 71 &&
                         trial.Target.Number <= 73)
                ...
                else if (trial.Target.Number >= 74 &&
                         trial.Target.Number <= 76)
                ...
                else if (trial.Target.Number >= 81 &&
                         trial.Target.Number <= 83)
                    // 30s Pause + Wechsel R=>L + CW ForceField
                {
                    trial.Target.Number =
                        trial.Target.Number - 70;
                    trial.ForceFieldType =
                ...
                else if (trial.Target.Number >= 84 &&
                         trial.Target.Number <= 86)
                ...
                {
                    myManipAnalysisGui.WriteToLogBox(
