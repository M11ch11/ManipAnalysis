                                ...
                                try
                                {
                                    foreach (Trial trial in taskTrialList)
                                    {
                                        ...
                                        if (baseline != null)
                                        {
                                            ...
                                            {
                                                taskMatlabWrapper.Execute("[forcePDRaw, forcePDsignRaw] = pdForceDirectionLineSegment([forceX(" + (dataPoint - 1) + ") forceY(" + (dataPoint - 1) + ")], [positionX(" + (dataPoint - 1) + ") positionY(" + (dataPoint - 1) + ")], [positionX(" + dataPoint + ") positionY(" + dataPoint + ")], forceFieldMatrix);");
                                                taskMatlabWrapper.Execute("[forcePD, forcePDsign] = pdForceDirectionLineSegment([(forceX(" + (dataPoint - 1) + ")-baselineForceX(" + (dataPoint - 1) + ")) (forceY(" + (dataPoint - 1) + ")-baselineForceY(" + (dataPoint - 1) + "))], [positionX(" + (dataPoint - 1) + ") positionY(" + (dataPoint - 1) + ")], [positionX(" + dataPoint + ") positionY(" + dataPoint + ")], forceFieldMatrix);");
