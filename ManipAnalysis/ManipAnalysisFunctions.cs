                                    ...
                                    foreach (var trial in taskTrialList)
                                    {
                                        ...
                                        if (baseline != null)
                                        {
                                                ...
                                                dataPoint++)
                                            {
                                                ...
                                                //AbsoluteForces noch nötig? Falls nicht --> raus!
